setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5a_bda_nom_det_nocost/")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
modelversion = "fulldataset-detfit-nocost-hmc"
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5b_bda_nom_det_nocost/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=1.5,width=2)
...
predictive.samples$ModelType = "det-nocost"
...
# get correlation
gof(agr_noattr$Probability,predictive.samples$Probability) #r=.85,r2=.72
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5b_bda_nom_det_nocost/graphs/qualitativepattern-",modelversion,".pdf",sep=""),height=3.5,width=5)
...
# get correlation
gof(predictive.samples$EmpProportion,predictive.samples$MAP) #r=.63,r2=.4
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5b_bda_nom_det_nocost/graphs/scatterplot-",modelversion,".pdf",sep=""),height=3.5,width=5)
