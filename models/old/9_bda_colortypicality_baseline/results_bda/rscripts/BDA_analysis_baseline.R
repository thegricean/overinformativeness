setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/9_bda_colortypicality_baseline")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/9_bda_colortypicality_baseline/results_bda/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=2,width=13)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/9_bda_colortypicality_baseline/results_bda/graphs/predictives-",modelversion,".pdf",sep=""),height=4,width=14)

library(hydroGOF)
gof(toplot$ModelProbability,toplot$Probability)
gof(toplot[toplot$ModelProbability > 0 & toplot$ModelProbability < 1,]$ModelProbability,toplot[toplot$ModelProbability > 0 & toplot$ModelProbability < 1,]$Probability)
