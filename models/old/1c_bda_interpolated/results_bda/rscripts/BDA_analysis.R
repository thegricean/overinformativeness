setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
numericSubset$param = factor(x=numericSubset$parameter,levels=c("fidelity_size","fidelity_color","cost_size","cost_color","beta_c","lambda","beta_t"))
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=2,width=15)

# look at joint distributions of typicality and size
params$SampleNum = rep(seq(1,nrow(params)/9),each=9)
spreadparams = params %>%
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/joint-cost-",modelversion,".pdf",sep=""),height=4,width=8)
...
#  geom_vline(xintercept = spreadparams$Median,color="blue") +
  facet_wrap(~AlphaBin)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/joint-typicality-alpha-",modelversion,".pdf",sep=""),height=5,width=8)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/joint-typicality-lengthweight-",modelversion,".pdf",sep=""),height=5,width=8)

ggplot(spreadparams, aes(x=TypColorMinusSize)) +
  geom_histogram() +
  geom_vline(xintercept = 0,color="red") +
  facet_grid(AlphaBin~LengthWeightBin)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/joint-",modelversion,".pdf",sep=""),height=5,width=8)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/fidelity-outliers-",modelversion,".pdf",sep=""),height=6,width=9) 
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/predictives-byitem-",modelversion,".pdf",sep=""),height=3,width=5)

cor(toplot$ModelProbability,toplot$Probability) 
# empirical typicality, interpolated: .85
...
ggplot(toplot, aes(x=ModelProbability,y=Probability,color=NumDistractors,shape=NumDiff)) +
  ...
  geom_abline(intercept=0,slope=1,color="gray60") +
  facet_grid(SufficientDimension~Utterance)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/predictives-",modelversion,".pdf",sep=""),height=5,width=9)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/predictives-collapsed-",modelversion,".pdf",sep=""),height=5,width=7)

cor(toplot$ModelProbability,toplot$Probability) 
# empirical typicality, interpolated: .99
...
#  geom_smooth(method="lm") +
  facet_grid(SufficientDimension~Utterance)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/scenevariation-",modelversion,".pdf",sep=""),height=5,width=9)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1c_bda_interpolated/results_bda/graphs/maxtypicalitydiffcases-",modelversion,".pdf",sep=""),height=6,width=10)
