setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5b_bda_nom_det/")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5a_bda_nom_det/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=1.5,width=5)
...
predictive.samples$ModelType = "det-cost"
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5a_bda_nom_det/graphs/qualitativepattern-",modelversion,".pdf",sep=""),height=3.5,width=5)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5a_bda_nom_det/graphs/scatterplot-",modelversion,".pdf",sep=""),height=3.5,width=5)
