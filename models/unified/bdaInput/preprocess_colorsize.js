...
var data = refModule.readCSV("bda_data_colorsize.csv"); // loads data with 46 "other utterance" cases excluded
console.log(data);
//console.log("Loading data complete...",+data.length+" data points");

var conditions = refModule.readCSV("./unique_conditions_colorsize.csv"); // loads unique conditions with 46 "other utterance" cases excluded
...
fs.writeFileSync('./bda_data_colorsize.json',
