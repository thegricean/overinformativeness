setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=2,width=13)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/joint-cost-",modelversion,".pdf",sep=""),height=4,width=8)
...
#  geom_vline(xintercept = spreadparams$Median,color="blue") +
  facet_wrap(~AlphaBin)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/joint-typicality-alpha-",modelversion,".pdf",sep=""),height=5,width=8)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/joint-typicality-lengthweight-",modelversion,".pdf",sep=""),height=5,width=8)

ggplot(spreadparams, aes(x=TypColorMinusSize)) +
  geom_histogram() +
  geom_vline(xintercept = 0,color="red") +
  facet_grid(AlphaBin~LengthWeightBin)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/joint-",modelversion,".pdf",sep=""),height=5,width=8)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/fidelity-outliers-",modelversion,".pdf",sep=""),height=6,width=9) 
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/predictives-byitem-",modelversion,".pdf",sep=""),height=3,width=5)

cor(toplot$ModelProbability,toplot$Probability) 
# unlogged, reduced conditions: .86
# unlogged, reduced conditions, hmc: .85
...
ggplot(toplot, aes(x=ModelProbability,y=Probability,color=NumDistractors,shape=NumDiff)) +
  ...
  geom_abline(intercept=0,slope=1,color="gray60") +
  facet_grid(SufficientDimension~Utterance)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/predictives-",modelversion,".pdf",sep=""),height=5,width=9)
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/predictives-collapsed-",modelversion,".pdf",sep=""),height=5,width=7)

cor(toplot$ModelProbability,toplot$Probability) 
# unlogged, reduced .99 
# unlogged, reduced, hmc .99
...
#  geom_smooth(method="lm") +
  facet_grid(SufficientDimension~Utterance)
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1a_bda_basic/results_bda/graphs/scenevariation-",modelversion,".pdf",sep=""),height=5,width=9)
