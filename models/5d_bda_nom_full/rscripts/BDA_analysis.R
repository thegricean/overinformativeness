setwd("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5d_bda_nom_full/")
library(ggplot2)
library(dplyr)
library(coda)
library(purrr)
...
modelversion = "fulldataset-typicalities-hmc"
...
numericSubset = params.samples %>% 
  filter(parameter %in% c("alpha", "freqWeight", "lengthWeight"))
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5d_bda_nom_full/graphs/parameterposteriors-",modelversion,".pdf",sep=""),height=1.5,width=5)
...
predictive.samples$ModelType = "nondet-cost"

write.table(predictive.samples,paste("predictive-barplot-",modelversion,".txt",sep=""),row.names=F,quote=F,sep="\t")
write.table(agr_noattr,"predictive-barplot-empirical.txt",row.names=F,quote=F,sep="\t")
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5d_bda_nom_full/graphs/qualitativepattern-",modelversion,".pdf",sep=""),height=3.5,width=5)
...
# get correlation
gof(predictive.samples$EmpProportion,predictive.samples$MAP) #r=.84,r2=.7
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/5d_bda_nom_full/graphs/scatterplot-",modelversion,".pdf",sep=""),height=4,width=6)
