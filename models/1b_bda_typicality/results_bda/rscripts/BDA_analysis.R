...
cor(toplot$ModelProbability,toplot$Probability) 
# empirical typicality, round 1: .98 
# empirical typicality, seed 8: .97
...
ggsave(paste("/Users/titlis/cogsci/projects/stanford/projects/overinformativeness/models/1b_bda_typicality/results_bda/graphs/maxtypicalitydiffcases-",modelversion,".pdf",sep=""),height=6,width=10)
