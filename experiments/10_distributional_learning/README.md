...
_________________
10/13/2016
## Thoughts on getting clearer typicality/ distribution data

- Maybe change order of typicality/ distribution rating and production to get purer results in typicality/ distribution measurements
- Maybe insert summary slide between exposure and next slide to show distribution of colored fruits in basket again
...
- Results:
    - Typicality:  <br />  
        <img src="../11_color_norming/results/graphs/png/typicalities.png" width="400"/>
...
- Results:
    ...
    - Typicality:  <br />  
        <img src="results/graphs/png/meantypicality.png" width="300"/>
        <img src="results/graphs/png/meantypicality_byitem.png" width="300"/>
...
- Results:
    - Production:  <br />  
        <img src="../12_production_calibration/results/graphs/png/distribution_effect_production.png" width="300"/>
    ...
    - Typicality:  <br />  
        <img src="../12_production_calibration/results/graphs/png/meantypicality_byitem.png" width="300"/>
...
- Results:
    - Production:  <br />  
        <img src="../14_production_calibration_dtyp/results/graphs/png/distribution_effect_production.png" width="300"/>
        - Same problem as in Exp 12
    - Typicality:  <br />  
        <img src="../14_production_calibration_dtyp/results/graphs/png/meantypicality_byitem.png" width="300"/>
...
- Participants: 15
- Aim:
	- With clarified instructions, that Daxy understands fruit names, look ate production and usage of overinformative expressions 
- Comments: 
