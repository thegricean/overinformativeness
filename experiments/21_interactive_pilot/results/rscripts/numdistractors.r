...
table(d$context,d$productiontatusClickedObj)
...
production$ColorMentioned = ifelse(grepl("green|purple|white|black|brown|purple|violet|yellow|gold|orange|silver|blue|pink|red", production$refExp, ignore.case = TRUE), T, F)
