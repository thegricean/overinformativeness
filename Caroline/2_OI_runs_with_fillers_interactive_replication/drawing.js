...
var highlightCell = function(game, player) {
  ...
  console.log(game.objects);
  var targetObject = _.filter(game.objects, function(x){return game.objects.targetStatus == "target"});
  console.log("targetobjs to be highlighted: ", targetObject);
  var upperLeftX = targetObject.trueX;
  var upperLeftY = targetObject.trueY;
