...
A single object can be referred to by many nouns---the same object may be called \emph{a dalmatian}, \emph{a dog}, or \emph{an animal}.
...
There was, however, some item-wise variation that the model left unexplained. For instance, 
%some items were referred to by their sub level term exceptionally often. For example, 
%the eagle was referred to with the sub-level term ``eagle'' in 91\% of trials, and 
many items from the candy domain, such as ``gummy bears'' or ``jelly beans,'' were referred to mostly by sub-level terms even where context should have permitted basic-level reference.
This may reflect improper calibration of our typicality or frequency measures (``candy'' was our lowest-frequency basic-level term), or it may reflect additional factors such as general salience \cite{westerbeek2015}.
