...
Here $\denote{l}(o)$ is the lexical meaning of the word $l$ when applied to object $o$. We take this to be a real number indicating the degree of acceptability of object $o$ for category $l$. We relate this to our empirically elicited typicality norms via an exponential relationship in order to preserve linearity of typicality differences on choice differences: $\denote{l}(o)=\gamma^{\text{typicality}(o,l)}$.
