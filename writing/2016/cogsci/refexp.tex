...
Moreover, our study bears analogy to the finding of ``overinformative'' behavior displayed by speakers who use additional modifiers in referring expressions, which are unnecessary for disambiguation \cite{the Gatt (and Koolen?) paper}. Just as adding modifiers does, choosing a level of reference entails deciding how much information to provide in an utterance, which may result in a more specific level of abstraction than necessary. To what extent such extra information is redundant opposed to being beneficial for communication and cognitive economy remains an interesting topic for discussion. 
