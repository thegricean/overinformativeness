...
\red{CONTINUE HERE BY GOING INTO:}

\begin{itemize}
	\item data cleanup (take caroline's description of basic levels cleanup as basis)
	\item exclusion of trials/participants (including exclusion of 46 cases that were not direct color or size mentions (eg "different color"))
	\item analysis -- predict overmodification from sufficient dimension and scene variation
\end{itemize}
