...
At this point we remain agnostic about the factors that contribute to an utterance's cost $c(u)$. In later sections we treat cost as a function of both an utterance's length and frequency. 
...
The resulting renormalized literal listener distributions for our example context in \figref{fig:sizesufficient} are shown in the middle columns in \tableref{tab:detliteral}. 
