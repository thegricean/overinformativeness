...
\paragraph{Results} Including typicality increased item-wise model-data correlation by \red{XXX}. Posteriors over parameters are shown in \figref{fig:typicalityparamposteriors}. \red{Discuss similarities/diffs to basic model.}
