...
\begin{table}
\centering
\caption{Hypothetical fidelity values for utterances (rows) as applied to objects (columns). \ek{judith: are you sure about these values? Haven't double checked them now.}}
