...
d2 <- ngram(terms=c("pink","red","yellow"),yr.start=1960)
...
pairs = c("black avocado","black pepper","blue apple","blue banana","brown banana","brown carrot","green apple","green avocado","green pear","green pepper","green tomato","orange carrot","orange pear","orange pepper","pink carrot","pink tomato","red apple","red avocado","red pepper","red tomato","yellow banana","yellow pear")
